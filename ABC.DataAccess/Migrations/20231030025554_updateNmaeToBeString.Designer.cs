...
namespace ABC.DataAccess.Migrations
{
    ...
    [Migration("20231030025554_updateNmaeToBeString")]
    partial class updateNmaeToBeString
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ABC.Models.UserManagement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContactNumber = 9568271611L,
                            DateCreated = new DateTime(2023, 10, 30, 10, 55, 53, 897, DateTimeKind.Local).AddTicks(9704),
